...
class EditSingleSaleFormBase extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        const { date, model, code, color, customerName, amountSold, priceInBolivianos,
            priceInSoles, totalToPayInBolivianos, totalToPayInSoles, commentary, isLoading,
...
const EditSingleSaleForm = withRouter(withFirebase(EditSingleSaleFormBase));

const condition = (authUser) => {
    return authUser != null;
}

export default withAuthorization(condition)(EditSingleSale);